...
{
	echo "Resultado da Pesquisa por contareceber "."<br>";
	while($contareceber = mysql_fetch_array($resultado))
			{
			echo "Codigo  : ".$contareceber['codigo']."<br>".
                 "parcela    : ".$contareceber['parcela']."<br>".
                 "valor    : ".$contareceber['valor']."<br>".
                 "Status   : ".$contareceber['status']."<br>".
                 "vencimento: ".$contareceber['vencimento']."<br>".
                 "Data Conta: ".$contareceber['dataconta']."<br>".
                 "codpessoa: ".$contareceber['codpessoa']."<br><br>";
                 ;
			}
}
