...
$sql = "insert into banco (codigo,nome) 
        values ('$codigo','$nome')";
...
$sql = "update banco set nome = '$nome'
        where codigo = '$codigo'";
...
$sql = "delete from banco where codigo = '$codigo'";
...
<body>
    <div id="box">
        <form name="formulario" method="post" action="banco.php">
...
if (isset($_POST['pesquisar'])) {
    ...
    if (mysql_num_rows($resultado) == 0) {
        ...
        echo "<h2>Resultado da Pesquisa por bancos</h2>";
        ...
        echo "<th>Código</th><th>Nome</th>";
        echo "</tr>";
        while ($banco = mysql_fetch_array($resultado)) {
            echo "<tr>";
